...
```
python lr_asd/train.py --dataPathAVA AVADataPath --download 
```
...
```
python lr_asd/train.py --dataPathAVA AVADataPath
```
...
```
python lr_asd/train.py --dataPathAVA AVADataPath --evaluation
```
...
```
python lr_asd/Columbia_test.py --evalCol --colSavePath colDataPath
```
...
```
python lr_asd/Columbia_test.py --evalCol --pretrainModel lr_asd/weight/finetuning_TalkSet.model --colSavePath colDataPath
```
...
```
python lr_asd/Columbia_test.py --videoName 0001 --videoFolder demo
```
...
```
python lr_asd/Columbia_test.py --videoName 0001 --videoFolder demo --pretrainModel lr_asd/weight/finetuning_TalkSet.model
```
